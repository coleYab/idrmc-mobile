        ...
        <View className="bg-card rounded-t-3xl p-4 pb-8 shadow-lg border-t border-border/50">
                ...
                {attachments.map((file, index) => (
                  ...
                  >
                    ...
                    <TouchableOpacity
                      ...
                      className="absolute top-1 right-1 bg-foreground/60 rounded-full p-1"
                    >
                      <X color="#c2d3cd" size={12} />
                    </TouchableOpacity>
                  </View>
                ))}
              </ScrollView>
          ...
          <View className="flex-row items-end gap-3">
            <View className="flex-1 flex-row items-end bg-muted/30 border border-border/50 rounded-3xl px-2 py-1 shadow-sm">
              ...
              >
                <ImageIcon color="#847e89" size={22} />
              </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              className={`w-12 h-12 rounded-full justify-center items-center shadow-sm mb-0.5 ${
