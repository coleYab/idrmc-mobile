...
const typeOptions = ["ALL", "EMAIL", "SMS", "PUSH", "IN_APP"];

const statusOptions = ["ALL", "PENDING", "SENT", "FAILED", "READ"];
...
const NotificationsTab = () => {
  ...
  }, [searchQuery, typeFilter, statusFilter, sortBy, notificationsData]);
